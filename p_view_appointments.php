...
<div class="row">
    ...
    <div class="column left">
        <form action="p_view_appointments.php" method="POST">
            <div class="aa">
                <a href="p_dashbord.php" class="previous">&laquo; Previous</a>
            </div>
    </div>
    <div class="column right1">
        <center><h3>Your Appointments</h3>
            <?php
            $sql="SELECT patient.first_name, patient.last_name, doctor.d_first_name, doctor.d_last_name, appointment.date, 
                    ...
                    appointment.patient_ID INNER JOIN doctor ON doctor.doctor_ID = appointment.doctor_ID where patient.username = '{$_SESSION["username"]}' ORDER BY appointment.date";
            $res=$db->query($sql);
            if($res->num_rows>0)
            {
