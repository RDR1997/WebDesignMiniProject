...
<div class="row">
    ...
    <div class="column left">
        <form action="delete_Appointment.php" method="POST">
            ...
            <table>
                ...
                <tr><td><button class="side_nav" name="a_view_appointment">Delete Appointments</a></button></td></tr>
    ...
    <div class="column right1">
        ...
        if(isset($_POST['delete'])){
            ...
            $query = "DELETE FROM appointment WHERE appointment.appointment_ID = '$appointment_ID';";
